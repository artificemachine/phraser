...
import { PhraserKeysShortcutInput } from "./PhraserKeysShortcutInput";
 ...
 * - "phraser_keys": Uses PhraserKeysShortcutInput with backend key events
 */
export const ShortcutInput: React.FC<ShortcutInputProps> = (props) => {
  ...
  if (keyboardImplementation === "phraser_keys") {
    return <PhraserKeysShortcutInput {...props} />;
  }
